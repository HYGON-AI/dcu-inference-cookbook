...
Qwen2.5-VL 是 Qwen 系列的多模态视觉语言模型，包含4B 7B、32B、72B 等多个参数规模。模型原生支持图像、文本、视频等多种输入，在视觉理解、文档解析、视频问答、目标定位等任务上表现优异，结合 vLLM 可实现高吞吐、低延迟的在线推理服务。
...
| 模型 | 参数量 | 上下文 | 推荐硬件 |
|------|--------|--------|---------|
| Qwen2.5-VL-3B-Instruct | 3B | 128K | 1x BW1000 64GB |
| Qwen2.5-VL-7B-Instruct | 7B | 128K | 1x BW1000 64GB |
| Qwen2.5-VL-32B-Instruct | 32B | 128K | 4x BW1000 64GB |
| Qwen2.5-VL-72B-Instruct | 72B | 128K | 8x BW1000 64GB |


## 启动命令
### 环境变量
```bash
export VLLM_USE_MODELSCOP=1
