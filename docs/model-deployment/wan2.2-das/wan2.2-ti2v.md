...
| [Wan-AI/Wan2.2-TI2V-5B-INT8](https://www.modelscope.cn/models/hygon/Wan2.2-TI2V-5B-INT8-w8a8) | INT8     | BW1000/BW1100 | 8x   | Offline  | [启动命令](#Wan22-TI2V-5B-INT8) |
...
```bash
export USE_INT8=1
export model_base=./models/Wan2.2-TI2V-5B-INT8/
